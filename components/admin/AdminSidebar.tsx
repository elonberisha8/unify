...
export const DEFAULT_ADMIN_NAV: AdminNavItem[] = [
  ...
  { key: "emails", label: "Email Center", icon: <FileTextIcon className="h-4 w-4" />, href: "/admin/emails" },
  { key: "groups", label: "Grupet", icon: <UsersIcon className="h-4 w-4" />, href: "/admin/grupet" },
